...
class BigtableTableScan(
  ...
  def getPartitions: Array[Partition] = {
    try {
      ...
      val tabletRanges: Array[BigtableTabletRange] = new Array[BigtableTabletRange](keyOffsets.size)
      ...
      val partitions = tabletRanges.flatMap { tabletRange =>
        val partitionRangeSet: RangeSet[RowKeyWrapper] = TreeRangeSet.create[RowKeyWrapper]()
